...
BEGIN
    ...
    DECLARE @col SYSNAME, @is_char BIT, @col_count INT, @col_expr NVARCHAR(max), @col_diff INT, @col_distinct INT,@loopcounter INT=0,@stopwatch datetime, @elaspedtimems int;   
