...
param(
[Parameter(Mandatory)] 
[string]$p_SearchedString,  
[switch] $p_truncate = $false,
[string]$_log_dir = "D:\Log\"
)

$PSDefaultParameterValues['*-Dba*:EnableException'] = $true
$PSDefaultParameterValues['*:EnableException'] = "Stop"

Start-Transcript -Path ${_log_dir}SearchStringInMSSQLModules.log -Force
...
try{
	...
	{ 
	 Write-DbaDbTableData -SqlInstance grasrlyosqldba\DBA01 -InputObject $SearchStringInModules -Table SearchStringInModules -Database DBATOOLS -AutoCreateTable	
	}
}
catch
{
